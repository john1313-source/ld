...
- `etf_type`: ETF 하위 유형입니다. `배당성장`, `고배당`, `커버드콜`, `리츠`, `우선주`, `해외배당`, `섹터`, `벤치마크`를 지원합니다.
...
ETF는 `SCHD`, `VIG`, `VYM`, `DGRO`, `DGRW`, `NOBL`, `SDY`, `DVY`, `HDV`, `SPYD`, `SPHD`, `RDVY`, `JEPI`, `JEPQ`, `QYLD`, `XYLD`, `RYLD`, `DIVO`, `VNQ`, `SCHH`, `PFF`, `PFFD`, `VYMI`, `IDV`, `SCHY`, `XLU`, `FDVV`, `VOO`, `QQQ`, `DIA`를 포함합니다.
